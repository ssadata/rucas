...
cols1 = ["folio_unico", "P15_1_1B", "P15_1_2", "P15_1_3A", "P15_1_3B", "P15_2_1B", "P15_2_2", "P15_2_3A", "P15_2_3B", \
        "P15_3_1B", "P15_3_2", "P15_3_3A", "P15_3_3B", "P15_1_W1", "P15_2_W1", "P15_3_W1"]
          
cols2 = ["folio_unico", "P15_1_1",	"P15_1_1A", "P15_1_2",	"P15_1_3A",	"P15_1_3B", "P15_2_1",	"P15_2_1A", \
         "P15_2_2",	"P15_2_3A",	"P15_2_3B", "P15_3_1",	"P15_3_1A",	"P15_3_2",	"P15_3_3A",	"P15_3_3B"]
	  
cols3 = ["folio_unico", "P15_1_1", "P15_1_1A", "P15_1_2", "P15_1_3A", "P15_1_3B", "P15_2_1", "P15_2_1A", "P15_2_2", "P15_2_3A", \
	 "P15_2_3B", "P15_3_1", "P15_3_1A", "P15_3_2", "P15_3_3A", "P15_3_3B"]


												

          
df1 = bases["w1_bdm_p"].loc[:, cols1]
          
df2 = bases["w2_bdm_p"].loc[:, cols2]
          
df3 = bases["w3_bdm_p"].loc[:, cols3]
