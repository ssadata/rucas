...
cols1 = ["P15_1_1B", "P15_2_1B", \
        "P15_3_1B",  "P15_1_W1", "P15_2_W1", "P15_3_W1"]
          
cols2 = ["P15_1_1", "P15_1_1A", "P15_2_1", "P15_2_1A",\
	"P15_3_1", "P15_3_1A"]
	  
#cols3 = ["folio_unico", "P15_1_1", "P15_1_1A", "P15_2_1", "P15_2_1A", \
#	"P15_3_1", "P15_3_1A"]
...
df2 = bases["w2_bdm_p"].loc[:, cols + cols2]
          
df3 = bases["w3_bdm_p"].loc[:, cols + cols2]
